...
export const metadata: Metadata = {
  title:
    "Mastering Negative Prompts: The Secret to Reliable AI Agents | Substratia",
  description:
    "Learn how to write effective negative prompts that prevent AI agents from making costly mistakes. Includes real-world examples and best practices.",
  openGraph: {
    title: "Mastering Negative Prompts: The Secret to Reliable AI Agents",
    description:
      "Learn how to write effective negative prompts that prevent AI agents from making costly mistakes.",
  },
};
    ...
    <main className="min-h-screen text-white py-12">
      <article className="container mx-auto px-4 max-w-3xl">
        <BlogHeader
          ...
          tags={[{ label: "Prompt Engineering" }]}
          subtitle="Most developers focus on what they want AI to do. The pros focus on what it should never do."
        />

        {/* Content */}
        <div className="prose prose-lg prose-invert max-w-none">
          <p>
            When building AI agents, there&apos;s a counterintuitive truth that
            experienced developers discover:
            <strong>
              defining what your agent should NOT do is often more important
              than defining what it should do.
            </strong>
          </p>

          <p>
            This concept, known as &ldquo;negative prompting&rdquo; or creating
            &ldquo;guardrails,&rdquo; is the difference between a reliable
            production system and an agent that costs you money, reputation, or
            worse.
          </p>
          ...
          <ul>
            <li>
              An e-commerce agent that accidentally deletes your entire product
              catalog
            </li>
            <li>
            ...
            <li>
              An autonomous agent stuck in an infinite loop, burning through API
              credits
            </li>
          </ul>

          <p>
            Each of these disasters could have been prevented with well-crafted
            negative prompts. Let&apos;s learn how to write them.
          </p>
          ...
          <ol>
            <li>
              <strong>Clear prohibition:</strong> Unambiguous statement of what
              NOT to do
            </li>
            <li>
              <strong>Context:</strong> When this rule applies
            </li>
            <li>
              <strong>Reasoning:</strong> Why this matters (helps the AI
              understand intent)
            </li>
          </ol>
...
- WHY: Destructive operations are irreversible and can cause catastrophic data loss`}
          ...
          <p>
            Based on our experience building production AI agents, we&apos;ve
            identified six essential categories:
          </p>
...
- NEVER keep connections open indefinitely`}
          ...
          <p>
            Here&apos;s how to structure your negative prompts in a CLAUDE.md or
            agents.md file:
          </p>
...
- Always log actions for audit`}
          ...
          <ol>
            <li>
              <strong>Adversarial testing:</strong> Try to make your agent break
              its own rules
            </li>
            <li>
              <strong>Edge cases:</strong> Test boundary conditions and unusual
              inputs
            </li>
            <li>
              <strong>Injection testing:</strong> Attempt prompt injection
              attacks
            </li>
            <li>
              <strong>Stress testing:</strong> Run many iterations to catch
          ...
          <p>
            &ldquo;Don&apos;t do anything dangerous&rdquo; is not specific
            enough. Define exactly what &ldquo;dangerous&rdquo; means in your
            context.
          </p>

          <h3>2. Too Many Rules</h3>
          <p>
            Having 100 negative prompts dilutes their importance. Focus on the
            10-20 most critical rules.
          </p>

          <h3>3. No Context</h3>
          <p>
            Rules without context can be misapplied. Always explain when rules
            apply.
          </p>

          <h3>4. Forgetting Positive Alternatives</h3>
          <p>
            When you say &ldquo;never do X,&rdquo; also explain what to do
            instead.
          </p>
          ...
          <p>
            One of our most popular templates is the Loop Guardian system,
            designed to prevent autonomous agents from getting stuck.
...
- Should we pivot strategy?`}
          ...
          <p>
            Negative prompts are not about limiting your AI agent-they&apos;re
            about making it reliable enough to trust with important tasks. The
            best agents are defined as much by what they refuse to do as by what
            they can accomplish.
          </p>

          <p>
            Start with the six categories above, customize them for your use
            case, and test rigorously. Your future self (and your users) will
            thank you.
          </p>
          ...
          posts={[
            {
              ...
              title: "How to Build Claude Agents: Complete 2026 Guide",
