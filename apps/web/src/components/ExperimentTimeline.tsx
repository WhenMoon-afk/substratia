...
import { type Experiment, GITHUB_REPO, patternColorMap } from '@/data/mirrorDemonsData'

export default function ExperimentTimeline({ experiment, isExpanded, onToggle }: {
          ...
          <div className="relative">
            ...
            <div className="space-y-6">
              {experiment.moments.map((moment, i) => (
                <div key={`${experiment.id}-moment-${i}`} className="relative pl-10">
                  {/* Dot */}
