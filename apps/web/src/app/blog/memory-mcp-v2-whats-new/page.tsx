...
export const metadata: Metadata = {
  title:
    "What's New in memory-mcp v2.5: From Python to TypeScript | Substratia",
  description:
    "memory-mcp has been completely rewritten from Python to TypeScript with SQLite. No more embeddings, no more pip - just npx and instant persistent memory for Claude.",
  keywords:
    "memory-mcp, claude memory, MCP server, TypeScript, SQLite, FTS5, persistent memory, claude-memory-mcp upgrade",
};
      ...
      <article className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8">
            If you found memory-mcp through an older article talking about
            Python, sentence transformers, and vector similarity search -
            that&apos;s the old version. Here&apos;s what changed and why.
          </p>
          ...
          <div className="bg-forge-cyan/10 border border-forge-cyan/30 rounded-xl p-6 mb-8">
            ...
            <p className="text-gray-300 mb-0">
              memory-mcp v2.5 is a complete rewrite: Python → TypeScript,
              embeddings → FTS5, pip → npx. It&apos;s simpler, faster, and has
          ...
          <p className="text-gray-300 mb-4">
            It worked, but had problems: slow startup, large memory footprint,
            complex installation, and embedding models that needed downloading.
          </p>
          ...
          <p className="text-gray-300 mb-4">
            We completely rewrote memory-mcp with a different philosophy:{" "}
            <strong>simplicity over features</strong>.
          </p>
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="text-gray-300">
                ...
                <tr className="border-b border-white/10">
                  ...
                  <td className="py-3 px-2 text-forge-cyan">
                    npx (one command)
                  </td>
                </tr>
                <tr className="border-b border-white/10">
          ...
          <p className="text-gray-300 mb-4">
            Embeddings are powerful but overkill for most memory use cases.
            Here&apos;s why:
          </p>
          <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-2">
            <li>
              <strong>Memory isn&apos;t search.</strong> You&apos;re not
              searching millions of documents - you&apos;re recalling dozens to
              hundreds of memories.
            </li>
            <li>
              <strong>Keywords work.</strong> FTS5 with BM25 ranking is fast and
              accurate for reasonable memory sizes.
            </li>
            <li>
              <strong>Simplicity wins.</strong> No model downloads, no GPU, no
              cold start.
            </li>
          </ul>
          <p className="text-gray-300 mb-4">
            For most users, &quot;find memories about authentication&quot; works
            perfectly with keyword search. If you truly need semantic search at
            scale, use a dedicated solution like Qdrant or Pinecone.
          </p>
          ...
          <ul className="list-disc pl-6 text-gray-300 mb-4 space-y-2">
            <li>
              <strong>Token budgeting</strong> - Recall respects your context
              limits
            </li>
            <li>
              <strong>Auto-summarization</strong> - Long memories get summarized
              on store
            </li>
            <li>
              <strong>Entity extraction</strong> - Automatic tagging of people,
              projects, concepts
            </li>
            <li>
              <strong>Soft deletes</strong> - Audit trail preserved for
              debugging
            </li>
            <li>
              <strong>Hybrid relevance</strong> - Scoring combines recency +
          ...
          <ol className="list-decimal pl-6 text-gray-300 mb-4 space-y-2">
            <li>
              Export your memories from the old JSON files (optional - start
              fresh is fine)
            </li>
  ...
  "mcpServers": {
    "memory": {
      ...
      "args": ["-y", "@whenmoon-afk/memory-mcp"]
          ...
          <p className="text-gray-300 mb-4">
            Restart Claude Desktop. You now have three tools:{" "}
